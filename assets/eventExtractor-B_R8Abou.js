import{U as e,W as t}from"./runtimeConfig-CPwrmQ-v.js";import{c as n}from"./apiRequestLedger-DL3b2P52.js";import{at as r}from"./index-BTN2SaJA.js";import{t as i}from"./temporalContext-CtzrjWrg.js";var a=2e4,o=!1,s=`外卖.快递.洗澡.开会.上课.下课.考试.健身.出去.出门.回来.回家.吃饭.做饭.午休.睡觉.上班.下班.面试.约会.看病.取.拿.分钟.小时.半小时.一会儿.一会.等下.待会.马上.明天.后天.下午.晚上.早上.过会.等会.要去.打算.准备.计划.约了.得去.该去`.split(`.`);function c(e){let t=e.toLowerCase();return s.some(e=>t.includes(e))}function l(e,t){return`用户刚才说了一句话，请判断里面有没有提到即将发生的事件（需要等待一段时间的事）。
