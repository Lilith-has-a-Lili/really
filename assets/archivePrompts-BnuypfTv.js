var e=[{id:`refine_atmosphere`,name:`氛围月记 (Atmosphere)`,content:`### [角色月度记忆精炼]
当前月份: \${dateStr}
身份: 你就是 \${char.name}
...
### 记忆输入
\${rawLog}`}],t=[{id:`preset_rational`,name:`理性精炼 (Rational)`,content:`### [System Instruction: Memory Archival]
当前日期: \${dateStr}
