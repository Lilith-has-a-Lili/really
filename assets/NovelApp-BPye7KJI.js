...
`,r+=`- 吐槽时必须带"喵"。
`,r+=`- 禁止写出人类式的长篇大论。
`),r},h=async(e,t,n,r,i=!1)=>{if(!e)return`Error: No Character`;if(!i&&e.writerPersona&&e.writerPersonaGeneratedAt&&Date.now()-e.writerPersonaGeneratedAt<10080*60*1e3)return e.writerPersona;let o=`你是一位人物心理分析专家和写作教练。我会给你一个虚拟角色的完整档案，以及与他/她互动的用户档案。请你深入理解这个角色，然后告诉我：
